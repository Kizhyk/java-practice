...
public class Task07 {
	public static void main(String[] args) {
		...
		double distanceAfterProgress = startDistance;
		double distance = 0;
		while (distanceAfterProgress < finishDistance) {
			if (startDistance == 0 || dailyProgress == 0) {
				break;
			}
			distance += distanceAfterProgress + distanceAfterProgress * dailyProgress / 100;
			distanceAfterProgress += distanceAfterProgress * dailyProgress / 100;
		}
		System.out.println(distance - startDistance);
	}
}