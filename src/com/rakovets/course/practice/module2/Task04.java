 ...
 * которая будет раcсчитывать размерность (т.е. размер стороны) квадратной плитки, которая находится на весах
 * сортировочной ленты, если известно, что на 1 кв.единицу площади необходимо 1 единица веса
 *
