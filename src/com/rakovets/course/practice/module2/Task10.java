 ...
 * которая рассчитывает избыточность веса пользователя от стандартного веса для его роста (стандартного вес = рост - 110).
 * Если известно:
 *
 * @param height - рост
 * @param weight - вес
...
public class Task10 {
	public static void main(String[] args) {
		...
		System.out.println(weight - standardWeight);
	}
}